...
import { DEFAULT_PHOTO, deriveSiblingRelations, openLightbox, initLightbox, collectStoryAlbumImages } from './config.js?v=20260904l';
import { mountLikeButton, mountStoryLikeButton, mountStoryComment } from './likes.js?v=20260904h';
import { mountRatingBox, fetchRank, cachedRank } from './ratings.js?v=20260904l';
...
export function renderStoriesTimeline(cats, siteConfig) {
  ...
  resultsBox.querySelectorAll('.story-item-comment[data-story]').forEach((el) => {
    mountStoryComment(el, el.dataset.story);
  });
}
